...
OBJS=main.o inmode.o outmode.o tokens.o tokenize.o dtokeniz.o select.o t64.o d64.o utility.o
CFLAGS=-Wall
...
inmode.o: inmode.c tokenize.h version.h inmode.h select.h t64.h d64.h
